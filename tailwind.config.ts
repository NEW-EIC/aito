  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Semantic tokens — drive light + dark off CSS variables defined in globals.css.
        // Use these in components (e.g. bg-surface, text-fg) so themes Just Work.
      ...
      fontFamily: {
        // Inter for display + body (matches Design's choice — editorial yet modern,
        // strong CJK fallback chain via PingFang / Noto Sans SC|TC).
        display: [
      ...
      borderRadius: {
        // Tighter than Tailwind defaults — gives editorial feel
        card: "6px",
        pill: "999px",
      },
      boxShadow: {
        // Match Design's CSS vars exactly
      ...
      fontFeatureSettings: {
        // Tabular numbers for tickers + financial data
        tabular: '"tnum"',
      },
    },
  },
